...
# VARIABLES
# dim1
dimensions_1 = ["requests", "timespan", "standard_deviation", "inter_req_mean_seconds", "read_pages"]
# dim2
...
pathlib.Path("Latex/Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)).mkdir(parents=True, exist_ok=True)
...
# display
for cluster_id in num_cluster:
    cluster_session = sessions[sessions.global_cluster_id == cluster_id].global_session_id.unique()
    ...
    # graph
    session_draw(cluster_id, str(n_clusters_1)+"x"+str(n_clusters_2), sessions_id, log, urls, category_list)
    ...
    latex_output.write("\\begin{frame}{Cluster "+str(cluster_id)+" -- Graphs}\n    \\resizebox{\\textwidth}{!}{\n    \\begin{tabular}{c|c|c|c|c}\n        \\huge{"+str(sessions_id[0])+"} & \\huge{"+str(sessions_id[1])+"} & \\huge{"+str(sessions_id[2])+"} & \\huge{"+str(sessions_id[3])+"} & \\huge{"+str(sessions_id[4])+"} \\\\\n        \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[0])+"} & \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[1])+"} & \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[2])+"} & \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[3])+"} & \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[4])+"} \\\\\n        \\hline\n        \\huge{"+str(sessions_id[5])+"} & \\huge{"+str(sessions_id[6])+"} & \\huge{"+str(sessions_id[7])+"} & \\huge{"+str(sessions_id[8])+"} & \\huge{"+str(sessions_id[9])+"} \\\\\n        \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[5])+"} & \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[6])+"} & \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[7])+"} & \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[8])+"} & \\includegraphics[width=\\textwidth, keepaspectratio]{Graphs/"+str(n_clusters_1)+"x"+str(n_clusters_2)+"/"+str(cluster_id)+"_session"+str(sessions_id[9])+"}\n    \\end{tabular}}\n\n")
